...
ssSetChecksumVal ( S , 0 , 2034850735U ) ; ssSetChecksumVal ( S , 1 ,
2896990022U ) ; ssSetChecksumVal ( S , 2 , 4267034467U ) ; ssSetChecksumVal (
S , 3 , 318101763U ) ; { mxArray * slVerStructMat = NULL ; mxArray * slStrMat
