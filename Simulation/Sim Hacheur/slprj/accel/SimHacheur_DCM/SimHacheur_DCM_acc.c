#include "__cf_SimHacheur_DCM.h"
#include <math.h>
#include "SimHacheur_DCM_acc.h"
#include "SimHacheur_DCM_acc_private.h"
#include <stdio.h>
#include "simstruc.h"
...
[ 1 ] ; _rtB -> cvkeszmnjq [ 2 ] = _rtP -> P_5 [ 2 ] ; _rtB -> je1asji303 =
_rtP -> P_6 ; _rtB -> k3taxnr0ym = _rtP -> P_7 ; _rtB -> o02s3kwi5d = _rtP ->
P_8 ; _rtB -> htqpx4f112 = _rtP -> P_9 ; ssCallAccelRunBlock ( S , 1 , 5 ,
SS_CALL_MDL_OUTPUTS ) ; } o33zqjjt5d = ssGetT ( S ) ; _rtB -> fdkghnhej4 =
ssGetTStart ( S ) ; o33zqjjt5d -= _rtB -> fdkghnhej4 ; if ( ssIsSampleHit ( S
, 1 , 0 ) ) { _rtB -> mdyadk04ie = _rtP -> P_10 ; } o33zqjjt5d =
muDoubleScalarRem ( o33zqjjt5d , _rtB -> mdyadk04ie ) ; o33zqjjt5d =
look1_binlxpw ( o33zqjjt5d , _rtP -> P_12 , _rtP -> P_11 , 1U ) ; _rtB ->
f10ve052uj = muDoubleScalarFloor ( _rtP -> P_13 * o33zqjjt5d ) ; _rtB ->
i0htfp3fk2 = _rtP -> P_14 * _rtB -> f10ve052uj ; if ( ssIsMajorTimeStep ( S )
) { _rtDW -> p4xqdips0v = _rtB -> i0htfp3fk2 >= _rtP -> P_15 ? 1 : _rtB ->
i0htfp3fk2 > _rtP -> P_16 ? 0 : - 1 ; } _rtB -> da0dudg0f4 = _rtDW ->
p4xqdips0v == 1 ? _rtP -> P_15 : _rtDW -> p4xqdips0v == - 1 ? _rtP -> P_16 :
_rtB -> i0htfp3fk2 ; o33zqjjt5d = ssGetT ( S ) ; _rtB -> ch4s12p1rz =
ssGetTStart ( S ) ; o33zqjjt5d -= _rtB -> ch4s12p1rz ; if ( ssIsSampleHit ( S
, 1 , 0 ) ) { _rtB -> koatzglqdb = _rtP -> P_17 ; } o33zqjjt5d =
muDoubleScalarRem ( o33zqjjt5d , _rtB -> koatzglqdb ) ; _rtB -> ahsodbcljv =
look1_binlxpw ( o33zqjjt5d , _rtP -> P_19 , _rtP -> P_18 , 1U ) ; if (
ssIsSampleHit ( S , 1 , 0 ) ) { if ( ssIsMajorTimeStep ( S ) ) { _rtDW ->
erjsjr2qzo = ( _rtB -> da0dudg0f4 >= _rtB -> ahsodbcljv ) ; } _rtB ->
abvu3xxawz = _rtDW -> erjsjr2qzo ; } if ( ssIsSampleHit ( S , 2 , 0 ) ) {
_rtB -> kkw31eze3p = _rtP -> P_20 * _rtB -> pvbm0keh00 [ 4 ] ; _rtB ->
kwlpbblstt = _rtP -> P_21 * _rtB -> pvbm0keh00 [ 6 ] ; } ssCallAccelRunBlock
( S , 1 , 44 , SS_CALL_MDL_OUTPUTS ) ; if ( ssIsSampleHit ( S , 1 , 0 ) ) {
currentTime = ssGetTaskTime ( S , 1 ) ; if ( ssIsMajorTimeStep ( S ) ) {
_rtDW -> dtdkrg2r4l = ( currentTime >= _rtP -> P_24 ) ; } } UNUSED_PARAMETER
( tid ) ; }
#define MDL_UPDATE
...
nt5ykhctxg += _rtP -> P_22 * _rtX -> nt5ykhctxg ; _rtXdot -> nt5ykhctxg +=
0.0 ; }
...
_rtP -> P_24 ; } static void mdlInitializeSizes ( SimStruct * S ) {
ssSetChecksumVal ( S , 0 , 1130646862U ) ; ssSetChecksumVal ( S , 1 ,
1901219165U ) ; ssSetChecksumVal ( S , 2 , 388080773U ) ; ssSetChecksumVal (
S , 3 , 3801077019U ) ; { mxArray * slVerStructMat = NULL ; mxArray *
